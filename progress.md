...
**Active Feature:** data-014 - 永恒之塔2战斗力本地筛选（已完成）
...
- 角色交易网站按用户筛选抓取螃蟹和 7881；单平台单次抓取上限由用户分别填写，默认螃蟹 100 条、7881 100 条；默认种族为“全部”，包含天族和魔族；网站分页可在 10、50、100 条之间切换，本地查询、战斗力筛选、排序和翻页均在前端完成，不重复抓取，不保存历史数据。
